        ...
        <div fluid="true" className="header-container my-5">
            <Container>
                <Row
                    ...
                    md={6}
                    lg={6}
                    className="row row-cols-lg-6 row-cols-md-6 d-flex justify-content-center align-items-center"
                >
                    <Col className="container">
                        <Container>
                            <h2 className="left-header-banner-text">
                                Medical Care Now
                                <br />
                                Simplified For <span className="text-blue">Everyone</span>
                            </h2>
                            <p className="mt-3">
                    ...
                    <Col className="banner-img-holder">
                        <div className="myCard">
                            <Card className="align-items-center text-center header-card">
                                <Card.Img
                                    className="mt-3"
                                    variant="top"
                                    style={{ width: "50px" }}
                                ...
                                <Card.Body>
                                    ...
                                    <Button className="btn-blue" variant="">
                                        Make Schedule
                                    </Button>
                                </Card.Body>
                            </Card>
